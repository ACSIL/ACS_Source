...
SCSFExport scsf_TradeManagementByStudy(SCStudyInterfaceRef sc)
{
	...
	SCInputRef Input_Logging                  = sc.Input[8];
	...
	if (sc.SetDefaults)	
	{
		...
		Input_Logging.Name = "Detailed Logging (for debugging)";
		Input_Logging.SetYesNo(0);
	...
	*****************************************/
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 1)
		{
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 2)
		{
	...
	if (PositionData.PositionQuantity == 0)
	{
		...
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 3)
		{
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 4)
		{
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 5)
		{
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 6)
		{
	...
	if (Result == 0)
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 7)
		{
	...
	{	
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 8)
		{
	...
	{	
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 9)
		{
	...
	{	
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 15)
		{
	...
	{	
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 10)
		{
	...
	{
		if (Input_Logging.GetYesNo() && LastLogMessageIdentifier != 14)
		{
	...
	if (Result == 1 && Input_Logging.GetYesNo() && LastLogMessageIdentifier != 11)
	{
	...
	else if (Result == SCT_SKIPPED_AUTO_TRADING_DISABLED && Input_Logging.GetYesNo() && LastLogMessageIdentifier != 13)
	{
	...
	else if (Result != 1 && Input_Logging.GetYesNo() && LastLogMessageIdentifier != 12)
	{
