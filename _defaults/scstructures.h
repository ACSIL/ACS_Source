...
public: 
	...
	public:
		...
		float RetracementLevels[ACSIL_DRAWING_MAX_LEVELS] = {0};
	...
	public:
		...
		COLORREF LevelColor[ACSIL_DRAWING_MAX_LEVELS] = {0};
		int LevelStyle[ACSIL_DRAWING_MAX_LEVELS] = {0};  // SubgraphLineStyles
		int LevelWidth[ACSIL_DRAWING_MAX_LEVELS] = {0};
